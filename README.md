...
---
for the repo: https://github.com/EazyEzar/n8n-feature-request-closer
add the template link in n8n creators (https://n8n.io/workflows/11369) to the readme.md 
...
----                 -------------         ------ ----                                                                
d-----        11/30/2025   1:34 PM                feature-request_closer                                              
d-----        11/29/2025   7:19 PM                gradio-file-explorer                                                
d-----        11/28/2025   2:25 PM                gradio-file-explorer-old                                            
d-----        11/18/2025  12:41 PM                n8n-airtable-to-hubspot-sync                                        
d-----        11/28/2025   2:36 PM                n8n-ingredient-bodyguard                                            
d-----        11/18/2025  12:53 PM                n8n-local-ai-invoice-ocr                                            
...
**Command Executed:**
```bash
cd feature-request_closer; git remote get-url origin
```

**Output:**
```
https://github.com/EazyEzar/n8n-feature-request-closer.git
```
